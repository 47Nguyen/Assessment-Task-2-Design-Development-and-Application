...
Every module and notebook imports from here so nobody hard-codes a path that
only works on their own laptop.
"""
...
# ---------------------------------------------------------------- paths
# Resolved relative to the repo root, so this works regardless of the current
# working directory a notebook happens to be launched from.
...
# ---------------------------------------------------------------- data facts
# Images are a uniform 60x80 RGB. numpy indexes rows first, so arrays are
# (height, width, channels) = (80, 60, 3).
IMG_WIDTH = 60
IMG_HEIGHT = 80
